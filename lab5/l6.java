...
public class l6 {
    ...
    static class Example {
        ...
        Example(int num1, int num2) {
            System.out.println("Конструктор Example_6() c 2 аргументами");
            min = Math.min(num1,num2);
            max = Math.max(num1,num2);
        }

        Example(int num) {
            System.out.println("Конструктор Example_6() c 1 аргументом");
            min = Math.min(min, num);
            max = Math.max(max, num);
        }
    }
